...
<body class="bg-gray-50 dark:bg-slate-900 font-sans antialiased transition-colors duration-200">
    <div id="app" class="flex flex-col h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
        ...
        <div class="flex flex-1 overflow-hidden relative">
            ...
            <!-- Sidebar -->
            <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'" class="absolute inset-y-0 left-0 z-30 w-64 bg-gray-50 dark:bg-slate-900 border-r border-gray-200 dark:border-slate-700 transition-transform duration-300 transform md:relative md:translate-x-0 ease-in-out">
                <div class="flex flex-col h-full">
                    ...
                    <nav class="flex-1 px-4 py-6 overflow-y-auto">
                        ...
                        <a href="{{ route('banks.index') }}" class="flex items-center px-3 py-2.5 mb-2 text-gray-700 hover:bg-gray-100 rounded-lg transition-colors {{ request()->routeIs('banks.*') ? 'bg-gray-100 text-gray-900' : '' }}">
                            <svg class="w-5 h-5 mr-3 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
