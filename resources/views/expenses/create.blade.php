...
@section('title', 'Record Expense - Finance Manager')
...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
    <!-- Header -->
    <div class="mb-8 text-center font: size 20px;">
    ...
    <form method="POST" action="{{ route('expenses.store') }}" class="space-y-8" id="expenseForm">
        ...
        <div class="mb-6" style="margin-top: 2rem;">
            ...
            @error('bank_id')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
            <p class="mt-2 text-xs text-gray-500">Type a new bank to create it automatically</p>
        </div>
